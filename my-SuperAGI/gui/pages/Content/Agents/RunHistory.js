          ...
          {runs &&
            runs.map((run) => (
              <div
                ...
                style={
                  selectedRunId === run.id ? { background: '#474255' } : { background: '#272335' }
                }
              >
                <div
                  style={{
                ...
                >
                  <div style={{ display: 'flex', order: '0' }}>
                    ...
                    <div
                      ...
                      style={run.status === 'RUNNING' ? { marginLeft: '7px' } : {}}
                    >
                      {run.name}
                    </div>
                  </div>
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', marginLeft: '10px' }}>
                    ...
                    <div className={styles.history_info}>{formatTime(run.last_execution_time)}</div>
                  </div>
                </div>
              </div>
            ))}
