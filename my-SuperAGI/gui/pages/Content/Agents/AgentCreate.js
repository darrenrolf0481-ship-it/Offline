    ...
    return (
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start' }}>
          {isPDF && (
            <div>
              <Image width={28} height={46} src={pdf_icon} alt="file-icon" />
            </div>
          )}
          {isTXT && (
            <div>
              <Image width={28} height={46} src={txt_icon} alt="file-icon" />
            </div>
          )}
          {!isTXT && !isPDF && (
            <div>
              <Image width={28} height={46} src="/images/default_file.svg" alt="file-icon" />
            </div>
          )}
          <div style={{ marginLeft: '5px', width: '100%' }}>
            <div style={{ fontSize: '11px' }} className={styles.single_line_block}>
              {file.name}
            </div>
          ...
          <div style={{ cursor: 'pointer' }} onClick={() => removeFile(index)}>
            <Image width={20} height={20} src="/images/close_light.svg" alt="close-icon" />
          </div>
        </div>
      </div>
    );
  ...
  return (
    <>
      <div className="row">
        ...
        <div
          className="col-6"
          style={{ overflowY: 'scroll', height: 'calc(100vh - 92px)', padding: '25px 20px' }}
        >
          <div>
          ...
          <div style={{ marginTop: '10px' }}>
            ...
            <div style={{ marginTop: '15px' }}>
              ...
              <div>
                <button className="secondary_button" onClick={addGoal}>
                  + Add
                </button>
              </div>
            </div>
            <div style={{ marginTop: '15px' }}>
              <label className={styles.form_label}>Model</label>
              <br />
            ...
            <div style={{ marginTop: '15px' }}>
              ...
              <div className="dropdown_container_search" style={{ width: '100%' }}>
                <div
                  className="custom_select_container"
                  onClick={() => setToolDropdown(!toolDropdown)}
                  style={{ width: '100%' }}
                >
                  {toolNames && toolNames.length > 0 ? (
                    ...
                    <div style={{ color: '#666666' }}>Select Tools</div>
                  )}
                  <Image
                    width={20}
                    height={21}
                ...
                <div>
                  {toolDropdown && (
                    <div className="custom_select_options" ref={toolRef} style={{ width: '100%' }}>
                      {tools &&
                        tools.map((tool, index) => (
                          <div key={index}>
                            {tool.name !== null && tool.name !== 'LlmThinkingTool' && (
                              <div
                                className="custom_select_option"
            ...
            {advancedOptions && (
              <div>
                <div style={{ marginTop: '15px' }}>
                  <label className={styles.form_label}>Agent Type</label>
                  <br />
                  <div className="dropdown_container_search" style={{ width: '100%' }}>
                    <div
                      className="custom_select_container"
                    ...
                    >
                      ...
                      <Image
                        ...
                        height={21}
                        src={
                          !agentDropdown ? '/images/dropdown_down.svg' : '/images/dropdown_up.svg'
                        }
                        alt="expand-icon"
                      />
                    </div>
                    <div>
                      {agentDropdown && (
                        <div
                          className="custom_select_options"
                          ref={agentRef}
                          style={{ width: '100%' }}
                        >
                ...
                <div style={{ marginTop: '15px' }}>
                  <div style={{ display: 'flex' }}>
                    <input
                      className="checkbox"
                      type="checkbox"
                      checked={addResources}
                      onChange={() => setAddResources(!addResources)}
                    />
                    <label
                      className={styles.form_label}
                      style={{ marginLeft: '7px', cursor: 'pointer' }}
                      onClick={() => setAddResources(!addResources)}
                    >
                      Add Resources
                    </label>
                  </div>
                    ...
                    <div style={{ paddingBottom: '10px' }}>
                      ...
                      >
                        <div>
                          ...
                          <p style={{ textAlign: 'center', color: '#888888', fontSize: '12px' }}>
                ...
                <div style={{ marginTop: '5px' }}>
                  ...
                  <div>
                    <button className="secondary_button" onClick={addConstraint}>
                      + Add
                    </button>
                  </div>
                </div>
                ...
                <div style={{ marginTop: '15px' }}>
                  ...
                  <div className="dropdown_container_search" style={{ width: '100%' }}>
                    <div
                      className="custom_select_container"
                      onClick={() => setRollingDropdown(!rollingDropdown)}
                      style={{ width: '100%' }}
                    >
                      ...
                      <Image
                        ...
                        height={21}
                        src={
                          !rollingDropdown ? '/images/dropdown_down.svg' : '/images/dropdown_up.svg'
                        }
                        alt="expand-icon"
                      />
                    </div>
                        ...
                        >
                          {rollingWindows.map((window, index) => (
                            <div
                              key={index}
                              className="custom_select_option"
                              onClick={() => handleWindowSelect(index)}
                              style={{ padding: '12px 14px', maxWidth: '100%' }}
                            >
                              {window}
                            </div>
                ...
                <div style={{ marginTop: '15px' }}>
                  <div style={{ display: 'flex' }}>
                    <input
                      ...
                      onChange={() => setLongTermMemory(!longTermMemory)}
                    />
                    <label
                      className={styles.form_label}
                      style={{ marginLeft: '7px', cursor: 'pointer' }}
                ...
                {longTermMemory === true && (
                  <div style={{ marginTop: '10px' }}>
                    ...
                    <div className="dropdown_container_search" style={{ width: '100%' }}>
                      <div
                        className="custom_select_container"
                        onClick={() => setDatabaseDropdown(!databaseDropdown)}
                        style={{ width: '100%' }}
                      >
                        {database}
                        <Image
                          ...
                          src={
                            !databaseDropdown
                              ? '/images/dropdown_down.svg'
                              : '/images/dropdown_up.svg'
                          }
                          alt="expand-icon"
                        />
                      </div>
                          ...
                          >
                            {databases.map((data, index) => (
                              <div
                                key={index}
                                className="custom_select_option"
                                onClick={() => handleDatabaseSelect(index)}
                                style={{ padding: '12px 14px', maxWidth: '100%' }}
                              >
                                {data}
                              </div>
