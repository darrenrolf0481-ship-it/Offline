  ...
  return (
    <>
      <div
        ...
        style={{ background: '#272335', padding: '15px', cursor: 'default' }}
      >
        ...
        >
          <div>
            <div className={styles.agent_info_box}>
              <div>
                <Image width={12} height={12} src="/images/calls_made.svg" alt="calls-icon" />
              </div>
              <div style={info_text_secondary}>Total Calls</div>
            </div>
            <div className={styles.feed_title} style={{ fontSize: '20px', marginLeft: '0' }}>
          ...
          <div>
            <div className={styles.agent_info_box}>
              <div>
                <Image width={12} height={12} src="/images/runs_made.svg" alt="runs-icon" />
              </div>
        ...
        <div className={styles.agent_info_box}>
          <div>
            <Image width={15} height={15} src="/images/flag.svg" alt="goals-icon" />
          </div>
        ...
        {agentDetails && (
          <div>
            {agentDetails.goal && agentDetails.goal.length > 0 && (
              <div
                className={styles.large_text_box}
                style={!showGoals ? { overflow: 'hidden', display: '-webkit-box' } : {}}
              >
          ...
          <div>
            {agentDetails.tools && agentDetails.tools.length > 0 && (
              <div>
                ...
                <div className={styles.agent_info_box}>
                  <div>
                    <Image width={15} height={15} src="/images/tools_dark.svg" alt="tools-icon" />
                  </div>
          ...
          <div>
            {agentDetails.constraints && agentDetails.constraints.length > 0 && (
              <div>
                ...
                <div className={styles.agent_info_box}>
                  <div>
                    <Image
                      width={15}
                      height={15}
                      src="/images/close_fullscreen.svg"
                      alt="constraint-icon"
                    />
                  </div>
                ...
                >
                  {showConstraints ? 'Show Less' : 'Show More'}
                </div>
              </div>
            )}
          </div>
        ...
        <div className={styles.agent_info_box}>
          <div>
            <Image width={15} height={15} src="/images/fact_check.svg" alt="queue-icon" />
          </div>
          <div style={info_text}>{agentDetails?.agent_type || ''}</div>
        </div>
        <div className={styles.agent_info_box}>
          <div>
            <Image width={15} height={15} src="/images/deployed_code.svg" alt="model-icon" />
          </div>
        ...
        <div className={styles.agent_info_box}>
          <div>
            <Image width={15} height={15} src="/images/overview.svg" alt="window-icon" />
          </div>
          <div style={info_text}>{agentDetails?.memory_window || 0} milliseconds</div>
        </div>
        <div className={styles.agent_info_box}>
          <div>
            <Image width={15} height={15} src="/images/key.svg" alt="permission-type-icon" />
          </div>
          <div style={info_text}>
