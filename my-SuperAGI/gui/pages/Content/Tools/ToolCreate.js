      ...
      <div>
        <div className="row" style={{ padding: '10px' }}>
          <div className="col-12">
            <div>
              <div className={styles1.page_title} style={{ marginTop: '10px' }}>
                Create new tool
              </div>
            </div>
                  ...
                  >
                    <div style={{ flex: '1' }}>
                      <input
                        ...
                        type="text"
                        value={goal.paramater}
                        onChange={(event) => handleGoalValue1Change(index, event)}
                      />
                    ...
                    <div>
                      <button
                        className={styles1.agent_button}
            ...
            <div className={styles.button_class}>
              ...
              <button className={styles1.agent_button} onClick={handleToolCreate}>
                Add
              </button>
            </div>
          </div>
