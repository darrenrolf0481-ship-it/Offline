      ...
      {applicationState === 'AUTHENTICATED' ? (
        ...
        <div className="signInStyle">
          <div className="signInTopBar">
            <div className="superAgiLogo">
              <Image width={132} height={72} src="/images/sign-in-logo.svg" alt="super-agi-logo" />
            </div>
          </div>
          <div className="signInCenter">
            {applicationState === 'NOT_AUTHENTICATED' ? (
              <div className="signInWrapper">
                ...
                <div className="signInInfo">
                  By continuing, you agree to Super AGI’s Terms of Service and Privacy Policy, and
              ...
              <div className="signInWrapper" style={{ background: 'transparent' }}>
                <div
                  ...
                  style={{ fontSize: '16px', fontFamily: 'Source Code Pro' }}
                >
                  {loadingText}
                </div>
              </div>
