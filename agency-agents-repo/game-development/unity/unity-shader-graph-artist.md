...
- Fragment texture samples: \_\_\_ (mobile limit: 8 for opaque, 4 for transparent)

ALU Instructions

- Estimated ALU (from Shader Graph stats or compiled inspection): \_\_\_
