...
JetBrains IDEs support _multi-module projects_, where a project can reference other projects as modules.
...
- **Sync file system before every operation** (default: enabled)  
  ...
  Operations that apply changes to files in your project that are _not_ made either in the IDE itself or by Serena may not be seen by the IDE.
