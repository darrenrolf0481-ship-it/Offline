...
export const pythonTools = [
  {
    name: "python",
    description: "Unified Python tool for virtual environment management, package installation, and script execution. Supports create_venv, pip_install, pip_freeze, run_script, and version actions.",
    inputSchema: z.object({
      action: z.enum(["create_venv", "pip_install", "pip_freeze", "run_script", "version"]).describe("Python action to perform"),
      ...
      output: z.string().describe("Output file path (for pip_freeze)").default("requirements.txt").optional(),
