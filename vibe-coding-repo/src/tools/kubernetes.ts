...
export const kubernetesTools = [
  ...
  },
  {
    ...
    inputSchema: z.object({
      ...
      allNamespaces: z
        .boolean()
        .describe('Get deployments from all namespaces')
        .default(false)
        .optional(),
    }),
    handler: async (args: any) => {
  ...
  },
  {
    ...
    inputSchema: z.object({
      ...
      allNamespaces: z
        .boolean()
        .describe('Get services from all namespaces')
        .default(false)
        .optional(),
    }),
    handler: async (args: any) => {
  ...
  },
  {
    ...
    inputSchema: z.object({
      ...
      fieldSelector: z
        .string()
        .describe("Field selector to filter events (e.g., 'type=Warning')")
        .optional(),
    }),
    handler: async (args: any) => {
      try {
  ...
  },
  {
    ...
    inputSchema: z.object({
      resourceType: z
        .string()
        .describe("Resource type (e.g., 'pod', 'deployment', 'statefulset', 'configmap')"),
