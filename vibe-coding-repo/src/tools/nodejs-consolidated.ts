...
export const nodejsTools = [
  {
    name: 'npm',
    description:
      'Unified npm/Node.js tool for package management and script execution. Supports install, run_script, outdated, init, and read_package actions.',
    inputSchema: z.object({
      action: z
        .enum(['install', 'run_script', 'outdated', 'init', 'read_package'])
        .describe('NPM action to perform'),
